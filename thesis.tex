...
\documentclass[11pt,final,dissertation]{wmthesis}
...
\thesisAuthor[Student Full Name]{Student Name}
...
\thesisCommittee[Computer Science]{Professor A}{College of William \& Mary}  % use {College of College of William \& Mary} -- Shanhe
...
%%--Option: unsorted bibliography with doi links (if hyperref package is included)
\renewcommand{\thesisBibStyle}{wmbib_nosrt_wurl}
